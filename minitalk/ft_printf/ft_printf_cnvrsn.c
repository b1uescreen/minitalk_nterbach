...
/*   Updated: 2023/05/31 18:23:29 by nterbach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	result "rslt".
	The function "nt_strjoin" frees the "substring", therefore it's set to
	NULL here.
*/
char	*add_cnvrsn(char *rslt, va_list args, char cnv)
{
	...
	rslt = nt_strjoin(rslt, substring);
	substring = NULL;
	return (rslt);
}
...
static char	*converter(va_list args, char cnv)
{
	...
	if (cnv == 'c' || cnv == 'd' || cnv == 'i')
		...
		substring = nt_strdup(va_arg(args, char *));
	else if (cnv == '%')
	{
