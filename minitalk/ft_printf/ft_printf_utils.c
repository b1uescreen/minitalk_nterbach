...
/*   Updated: 2023/05/31 17:28:51 by nterbach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	nt_str_writer(char *s1, char *s2, char *rslt);
...
/*
	...
	"nt_str_writer".
*/
char	*nt_strjoin(char *main_str, char *update)
{
	char	*rslt;
	int		main_len;
	int		updt_len;
	...
	{
		main_len = nt_strlen(main_str);
		updt_len = nt_strlen(update);
		rslt = (char *) malloc(main_len + updt_len + 1);
		nt_str_writer(main_str, update, rslt);
		main_str = NULL;
		update = NULL;
		return (rslt);
	}
